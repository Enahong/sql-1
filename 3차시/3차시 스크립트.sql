...
SELECT TO_CHAR(SYSDATE, 'DD'), TO_CHAR(SYSDATE, 'DAY'), TO_CHAR(SYSDATE, 'DDD')
FROM DUAL;
...
SELECT SYSDATE, 
       TO_CHAR(SYSDATE, 'W'),
       TO_CHAR(SYSDATE, 'WW'),
       TO_CHAR(TO_DATE('2019-10-10','YYYY-MM-DD'), 'W'), 
       TO_CHAR(TO_DATE('2019-10-10','YYYY-MM-DD'), 'WW')
FROM DUAL;



-- TO_DATE 함수 - 문자를 날짜로 변환
SELECT TO_DATE('2020-01-15 17:10:15', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;

SELECT TO_DATE('2020-01-15', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;

SELECT TO_DATE('20200115', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;

SELECT TO_DATE('2020-01-15', 'YYYYMMDD HH24:MI:SS')
FROM DUAL;
...
SELECT TO_NUMBER(TO_CHAR(SYSDATE, 'YYYY')) - 1 YEARS
...
-- 5. 현재일자(2020-01-15) 기준 ROUND(SYSDATE, 'YYYY') 를 실행하면 2020-01-01이 반환된다. 그럼 언제 시점부터 2021-01-01이 반환될까?

SELECT ROUND(TO_DATE('2020-06-30 23:59:59', 'YYYY-MM-DD HH24:MI:SS'), 'YYYY') AS THIS_YEAR
      ,ROUND(TO_DATE('2020-07-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'YYYY') AS NEXT_YEAR
  FROM DUAL;
