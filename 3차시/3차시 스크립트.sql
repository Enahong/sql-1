...
SELECT SYSDATE D1, 
       ...
       TO_CHAR(TO_DATE('2021-06-14','YYYY-MM-DD'), 'W') D4, 
       TO_CHAR(TO_DATE('2021-06-14','YYYY-MM-DD'), 'WW') D5
FROM DUAL;



-- TO_DATE 함수 - 문자를 날짜로 변환
SELECT TO_DATE('2021-06-14 17:10:15', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;

SELECT TO_DATE('2021-06-14', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;

SELECT TO_DATE('20210614', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;

SELECT TO_DATE('2021-06-14', 'YYYYMMDD HH24:MI:SS')
FROM DUAL;
...
--2. 2021년 6월 10일 애인과 처음 만났다. 100일, 500일, 1000일 기념파티를 하고 싶은데, 언제인지 계산하기가 힘드네...  
SELECT TO_DATE('2021-06-10', 'YYYY-MM-DD') + 100 AS "100일"
      ,TO_DATE('2021-06-10', 'YYYY-MM-DD') + 500 AS "500일"
      ,TO_DATE('2021-06-10', 'YYYY-MM-DD') + 1000 AS "1000일"
FROM DUAL ;
